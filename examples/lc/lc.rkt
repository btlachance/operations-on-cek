...
(define-cek lc
  ...
  #:initial [(modbegin modforms) -->
             ((modbegin
               ...
               (mf (define + (lamrest (varl args varsnil) (variadicaddimpl args) esnil))
               (mf (define - (lamrest (varl args varsnil) (variadicsubimpl args) esnil))
               (mf (define * (lam (varl m (varl n varsnil)) (multimpl m n) esnil))
               (mf (define / (lamrest (varl args varsnil) (variadicdivimpl args) esnil))
               ...
               (mf (define length (lam (varl xs varsnil) (lengthimpl xs) esnil))
